...
if __name__ == "__main__":
    ...
    weight = torch.randn(num_features, 10, device=device).contiguous()

    run_correctness_test(fused_gelu_sgp_norm_2d, gelu_sgp_norm_2d_torch, {'x': x, 'y': y, 'weight': weight})
    run_benchmark(fused_gelu_sgp_norm_2d, gelu_sgp_norm_2d_torch, (x, y, weight), rep, verbose=True)