...
def gelu_wgp_norm_kernel_bwd(
    ...
    x_grad_0, x_grad_1, x_grad_2, x_grad_3, x_grad_4, x_grad_5, x_grad_6, x_grad_7 = grads[0:8]
    y_grad_0, y_grad_1, y_grad_2, y_grad_3, y_grad_4, y_grad_5, y_grad_6, y_grad_7 = grads[8:16]
    (_w_grad_0, _w_grad_1, _w_grad_2, _w_grad_3, _w_grad_4, _w_grad_5, _w_grad_6,
     _w_grad_7, _w_grad_8, _w_grad_9, _w_grad_10, _w_grad_11, _w_grad_12, _w_grad_13, 
     _w_grad_14, _w_grad_15, _w_grad_16, _w_grad_17, _w_grad_18, _w_grad_19) = grads[16:]
    ...
    w_grad_10 = tl.sum(_w_grad_10, axis=0)
    w_grad_11 = tl.sum(_w_grad_11, axis=0)
    w_grad_12 = tl.sum(_w_grad_12, axis=0)
    w_grad_13 = tl.sum(_w_grad_13, axis=0)
    w_grad_14 = tl.sum(_w_grad_14, axis=0)
    w_grad_15 = tl.sum(_w_grad_15, axis=0)
    w_grad_16 = tl.sum(_w_grad_16, axis=0)
